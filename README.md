...
* All files were created and compiled on  Ubuntu 20.04 LTS using GCC with the command ```gcc -Wall -Werror -Wextra -pedantic -Wno-format *.c```
...
>>>>>>> 95066bc44e6d272ae4887b379516efe009019ede
